...
### Я хотел сделать функцию, чтобы факты о кошках автоматически переводились на другой язык, но сайт, с помощью которого я хотел сделать, требует привязать банковскую карту.
